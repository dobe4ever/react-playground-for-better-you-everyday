// src/components/mainLayout/Home.js
  ...
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 flex items-center justify-center">
       <img src='/assets/primary-logo.svg' alt='logo' className="w-full max-w-xs mx-auto" />
      </div>
        
      {/* h1 */}
      <h1 className="font-bold bg-gradient-orange text-center py-4 text-4xl text-transparent bg-clip-text">A Habit and Todo Tracking App</h1>
